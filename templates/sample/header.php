         ...
         <div id="divNavBarWrapper"
            ...
            <div id="divNavBarHeader"
               ...
               <a id="aBrand"
                  ...
                  <span>PHP MODEL 1.0 - template model</span>
               </a> <!-- <a id="aBrand" -->
            ...
            <div id="divNavBarOptions"
               ...
               <?php
                  ...
                  $jaOptions = [];
                  foreach ( $asModules as $sModule ){
                     $viewClassName = $sModule."View";
                     
                     if ( get_class( $this ) !== $viewClassName ){
                        $oView = new $viewClassName();
                     }
                     else{
                        $oView = $this;
                     }
                     
                     $jsModuleOptions = json_decode( $oView->getOptions() );
                     $jaOptions = array_merge( $jaOptions, $jsModuleOptions );
                     
                  }
                  
                  $jsOptions = json_encode( $jaOptions );
